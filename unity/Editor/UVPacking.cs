...
namespace Glim
{
    public static class UVPacking
    {
        ...
        [DllImport(DLL)]
        public static extern IntPtr uvpacker_create(uint width, uint height, uint iterations, [MarshalAs(UnmanagedType.I1)] bool bruteForce, [MarshalAs(UnmanagedType.I1)] bool holeFilling, [MarshalAs(UnmanagedType.I1)] bool enforce_min_scale);
